...
var Table = function () {
    ...
    _createClass(Table, [{
        ...
        value: function tableHtml() {
            ...
            var container = ['<div class="Table">', '<div class="T-title"style="overflow: auto;">', '<div>' + title + '</div>', '</div>', '<div class="T-content">', '<label for="T-sort">', '\u6BCF\u9875\u663E\u793A\u6761\u6570\uFF1A<select name="" id="T-pageNum">'].concat(_toConsumableArray([15, 10, 5].map(function (c) {
